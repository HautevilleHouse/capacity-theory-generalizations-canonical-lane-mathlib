...
import HautevilleHouse.CapacityTheoryGeneralizationsCanonicalLaneLean.GeneticCapacityObjects
...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "capacity-theory-generalizations",
  theoremObject := "Capacity Theory Generalizations",
